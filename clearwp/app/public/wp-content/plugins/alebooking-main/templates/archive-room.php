...
<div class="wrapper">
    <div class="booking_houses">

        <h1><?php if(isset( $options['title_for_houses'])){echo $options['title_for_houses'];} ?></h1>

        <div class="filter">
            <form method="post" action="<?php echo get_post_type_archive_link('house'); ?>">
        ...
        <?php
            ...
            if(!empty($_POST['submit'])){
                ...
                $houses_listing = new WP_Query($default_listing);

                if ( $houses_listing->have_posts() ) {

                    while ( $houses_listing->have_posts() ) { $houses_listing->the_post(); ?>
                    ...
                    echo paginate_links( array(
                        ...
                        'total' => $houses_listing->max_num_pages
                    ) );
